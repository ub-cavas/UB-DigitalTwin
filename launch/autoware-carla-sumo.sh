...
UB_AUTOWARE_PATCH_CENTERPOINT_CUDA="${UB_AUTOWARE_PATCH_CENTERPOINT_CUDA:-1}"
...
Defaults:
  ...
  UB_AUTOWARE_PATCH_CENTERPOINT_CUDA=${UB_AUTOWARE_PATCH_CENTERPOINT_CUDA}
...
Useful overrides:
  ...
  UB_AUTOWARE_PATCH_CENTERPOINT_CUDA=0 $(basename "$0")
...
EOF
  ...
  # The pinned image's CenterPoint CUDA source is patched and rebuilt once per container.
  # Set UB_AUTOWARE_PATCH_CENTERPOINT_CUDA=0 to skip this compatibility fix.
EOF
