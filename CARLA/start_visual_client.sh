...
export COMPOSE_PROJECT_NAME="${COMPOSE_PROJECT_NAME:-ub-carla-visual-client}"
export CONTAINER_NAME="${CONTAINER_NAME:-ub-carla-visual-client-container}"
export TRAFFIC_RENDERER_CONTAINER_NAME="${TRAFFIC_RENDERER_CONTAINER_NAME:-ub-carla-visual-client-traffic-renderer}"
...
exec docker compose up --build carla map-loader traffic-renderer
