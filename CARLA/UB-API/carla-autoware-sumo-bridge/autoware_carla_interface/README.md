...
| `vehicle_type`            | string | "vehicle.lincoln.mkz_2017"                                                        | Blueprint ID of the vehicle to spawn. The Blueprint ID of vehicles can be found in [CARLA Blueprint ID](https://carla.readthedocs.io/en/latest/catalogue_vehicles/)                                                 |
| `vehicle_color`           | string | ""                                                                                | Optional CARLA vehicle color as `R,G,B`. CARLA's `vehicle.lincoln.mkz_2017` blueprint does not support exterior coloring through this attribute, so the bridge ignores it for that model.                           |
