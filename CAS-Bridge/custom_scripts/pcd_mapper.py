...
def parse_args():
    ...
    p.add_argument('--voxel', type=float, default=0.1, help='Voxel size (meters) for downsampling (0 to disable)')
    ...
    p.add_argument('--pps', type=int, default=1_000_000)
    p.add_argument('--range', type=float, default=50.0)
...
class MiniKeyboardControl:
    ...
    def __init__(self, vehicle):
        ...
        self._STEER_RATE = 1.6         # steer change toward target /s
